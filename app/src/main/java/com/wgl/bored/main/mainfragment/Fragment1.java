...
public class Fragment1 extends FragmentPresenter<FragmentView1> implements BasePersenterImp.IListener{
...
//    private int time = 0;//页数，0代表第一页，以此类推
    ...
    @Override
    protected Class<FragmentView1> getViewClass() {
        return FragmentView1.class;
    }
...
//                toNet();
     ...
     */
    private void toNet(){
        MainModleNet net = new MainModleNet();
